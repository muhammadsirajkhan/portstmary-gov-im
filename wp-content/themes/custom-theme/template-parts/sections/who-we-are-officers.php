...
$header   = psm_get_who_we_are_officers_header($page_id);
$officers = psm_get_who_we_are_officers($page_id);
...
$heading_id = '' !== $title ? 'psm-who-we-are-officers-heading' : '';
?>
<section class="psm-commissioners-officers psm-who-we-are-officers" id="our-officers"<?php echo $heading_id ? ' aria-labelledby="' . esc_attr($heading_id) . '"' : ''; ?>>
